 ...
 * Only required if AnimationBuilder is used within the application and using IE/Edge or
 * Safari.
 ...
 * (window as any).__Zone_disable_on_property = true; // disable patch onProperty such
 * as onclick
